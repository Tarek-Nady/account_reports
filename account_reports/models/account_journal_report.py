...
class JournalReportCustomHandler(models.AbstractModel):
    ...
    def _get_custom_display_config(self):
        return {
            ...
            'components': {
                'AccountReportLine': 'report_custom.JournalReportLine',
            },
            'templates': {
                'AccountReportFilters': 'report_custom.JournalReportFilters',
                'AccountReportLineName': 'report_custom.JournalReportLineName',
            }
        }
