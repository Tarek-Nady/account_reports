...
class MulticurrencyRevaluationReportCustomHandler(models.AbstractModel):
    ...
    def _get_custom_display_config(self):
        return {
            'components': {
                'AccountReportFilters': 'report_custom.MulticurrencyRevaluationReportFilters',
            },
            'templates': {
                'AccountReportLineName': 'report_custom.MulticurrencyRevaluationReportLineName',
            },
        }
    ...
    def _customize_warnings(self, report, options, all_column_groups_expression_totals, warnings):
        if len(self.env.companies) > 1:
            warnings['report_custom.multi_currency_revaluation_report_warning_multicompany'] = {'alert_type': 'warning'}
        if options['custom_rate']:
            warnings['report_custom.multi_currency_revaluation_report_warning_custom_rate'] = {'alert_type': 'warning'}
