...
class PartnerLedgerCustomHandler(models.AbstractModel):
    ...
    def _get_custom_display_config(self):
        return {
            ...
            'components': {
                'AccountReportLineCell': 'report_custom.PartnerLedgerLineCell',
            },
            'templates': {
                'AccountReportFilters': 'report_custom.PartnerLedgerFilters',
                'AccountReportLineName': 'report_custom.PartnerLedgerLineName',
            },
        }
