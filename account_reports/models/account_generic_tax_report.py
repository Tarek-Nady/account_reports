...
class AccountTaxReportHandler(models.AbstractModel):
    ...
    def _get_custom_display_config(self):
        ...
        display_config['templates']['AccountReportFilters'] = 'report_custom.GenericTaxReportFiltersCustomizable'
        return display_config

    def _customize_warnings(self, report, options, all_column_groups_expression_totals, warnings):
        if 'report_custom.common_warning_draft_in_period' in warnings:
            ...
            if not self.env['account.move'].search_count(
                ...
                warnings.pop('report_custom.common_warning_draft_in_period')
        ...
        if rows:
            warnings['report_custom.tax_report_warning_inactive_tags'] = {}
    ...
    def action_periodic_vat_entries(self, options, from_post=False):
        ...
        if (options['date']['period_type'] != 'tax_period' and not self._is_period_equal_to_options(report,
            ...
            return {
                ...
                'tag': 'report_custom.redirect_action',
                'target': 'new',
                'params': {
...
class GenericTaxReportCustomHandler(models.AbstractModel):
    ...
    def _get_custom_display_config(self):
        ...
        parent_config['templates']['AccountReportLineName'] = 'report_custom.TaxReportLineName'
        ...
        for column_group_key, column_group_options in report._split_options_per_column_group(options).items():
            ...
            if is_inconsistent:
                ...
                if error > 0.001:
                    ...
                    warnings['report_custom.tax_report_warning_lines_consistency'] = {'alert_type': 'danger'}
